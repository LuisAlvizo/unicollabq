...
const VerticalMenuAdmin= () => {
  return (
    <Box sx={{ width: 250, bgcolor: '#FFFFFF', color: '#333', height: '100vh', padding: '1rem' }}>
      <List>
        <ListItem button component={Link} to="/admin/questions" sx={{ marginBottom: '1rem' }}>
          <ListItemIcon>
        ...
        <ListItem button component={Link} to="/admin/my-questions" sx={{ marginBottom: '1rem' }}>
          <ListItemIcon>
            <QuestionAnswerIcon sx={{ color: '#333' }} />
          </ListItemIcon>
          <ListItemText primary="Mis Publicaciones" sx={{ color: '#333' }} />
        </ListItem>
        <ListItem button component={Link} to="/admin/graphs" sx={{ marginBottom: '1rem' }}>
          <ListItemIcon>
            <InsightsIcon sx={{ color: '#333' }} />
          </ListItemIcon>
          <ListItemText primary="Graficas" sx={{ color: '#333' }} />
        </ListItem>
        <ListItem button component={Link} to="/admin/users" sx={{ marginBottom: '1rem' }}>
          <ListItemIcon>
            <PersonSearchIcon sx={{ color: '#333' }} />
          </ListItemIcon>
          <ListItemText primary="Usuarios" sx={{ color: '#333' }} />
        </ListItem>
      </List>
      <List>
        <ListItem button component={Link} to="/admin/profile" sx={{ marginBottom: '1rem' }}>
          <ListItemIcon>
