...
const VerticalMenuProf= () => {
  return (
    <Box sx={{ width: 250, bgcolor: '#FFFFFF', color: '#333', height: '100vh', padding: '1rem' }}>
      <List>
        <ListItem button component={Link} to="/profesor/questions" sx={{ marginBottom: '1rem' }}>
          <ListItemIcon>
        ...
        <ListItem button component={Link} to="/profesor/my-questions" sx={{ marginBottom: '1rem' }}>
          <ListItemIcon>
            <QuestionAnswerIcon sx={{ color: '#333' }} />
          </ListItemIcon>
      ...
      <List>
        <ListItem button component={Link} to="/profesor/profile" sx={{ marginBottom: '1rem' }}>
          <ListItemIcon>
...
export default VerticalMenuProf;
